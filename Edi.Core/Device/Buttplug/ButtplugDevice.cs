...
namespace Edi.Core.Device.Buttplug
{
    ...
    public class ButtplugDevice : DeviceBase<FunscriptRepository, FunscriptGallery>, IRange
    {
        ...
        // True for vibration-style actuators (driven by ButtplugController via VibrateAsync/OscillateAsync,
        // whose strength comes from CalculateSpeed → GetValueInRange(Min,Max)). Lets the UI route a
